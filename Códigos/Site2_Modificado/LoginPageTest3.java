...
public class LoginPageTest3 {
    ...
    public void testPageStructure() {
        ...
        assertTrue("Container should be visible", container.isDisplayed());

        // Verify banner section
        WebElement banner = driver.findElement(By.cssSelector("[data-test-id='login-banner']"));
        assertTrue("Banner should be visible", banner.isDisplayed());
        ...
        assertTrue("Welcome message should contain expected text", 
                  welcomeMessage.getText().contains("Seja bem vindo, acesse e aproveite todo o conteúdo"));

        // Verify login box
        WebElement loginBox = driver.findElement(By.cssSelector("[data-test-id='login-box']"));
        assertTrue("Login box should be visible", loginBox.isDisplayed());
        ...
        assertTrue("Login form should be visible", loginForm.isDisplayed());
        
        WebElement usernameInput = driver.findElement(By.cssSelector("[data-test-id='login-username-input']"));
        assertTrue("Username input should be visible", usernameInput.isDisplayed());
        
        WebElement passwordInput = driver.findElement(By.cssSelector("[data-test-id='login-password-input']"));
        assertTrue("Password input should be visible", passwordInput.isDisplayed());
        ...
        assertTrue("Forgot password link should be visible", forgotPasswordLink.isDisplayed());
        ...
        assertTrue("Create account link should be visible", createAccountLink.isDisplayed());
    ...
    public void testSuccessfulLogin() {
        ...
        try {
            ...
            assertTrue("Toast should be visible on successful login", toast.isDisplayed());
    ...
    public void testFailedLogin() {
        ...
        try {
            ...
            assertFalse("Error message should not be empty", errorMessage.getText().isEmpty());
        } catch (Exception e) {
    ...
    private void testSocialMediaRedirect(String socialIconId, String expectedDomainPart) {
        ...
        try {
            ...
            assertTrue("URL should contain " + expectedDomainPart, 
                      driver.getCurrentUrl().contains(expectedDomainPart));
        } finally {
